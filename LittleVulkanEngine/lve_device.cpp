...
namespace lve
{
    ...
    void LveDevice::pickPhysicalDevice()
    {
        ...
        for (const auto &device : devices)
        {
            ...
            std::cout << "  Name: " << dp.deviceName << std::endl;
            std::cout << "  Type: ";
    ...
    void LveDevice::createLogicalDevice()
    {
        ...
        std::cout << "GraphicsFamily: " << indices.graphicsFamily << ", PresentFamily: "
                  << indices.presentFamily << ", size: " << uniqueQueueFamilies.size() << std::endl;
    ...
    QueueFamilyIndices LveDevice::findQueueFamilies(VkPhysicalDevice device)
    {
        ...
        for (int i = 0; i < queueFamilyCount; ++i)
        {
            ...
            std::cout << "  Queue count: " << qf.queueCount << "\n";
            ...
            std::cout << "  Timestamp valid bits: " << qf.timestampValidBits << "\n";
            std::cout << "  Min image transfer granularity: "
                      << qf.minImageTransferGranularity.width << "x"
                      << qf.minImageTransferGranularity.height << "x"
